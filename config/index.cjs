...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx55ae6914cc2ccab9',

  // 使用微信测试号时才需要填写：公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'a54a33367baccbf2624fad43f6af4c68',
  ...
  TIAN_API: {
    ...
    key: '6248c4475cc69b0d1b18ff42b2d791f2',
...
//     },
  ...
  CALLBACK_TEMPLATE_ID: 'G6ZOV-lJ-p6DueUa5biBujCj0RBZJQKQVTDiYdiAGGQ',
  ...
  CALLBACK_USERS: [
    {
      ...
      {{date.DATA}}
城市：{{city.DATA}}        今日天气：{{tian_api_weather_weather_0.DATA}} {{tian_api_weather_lowest_0.DATA}} ~ {{tian_api_weather_highest_0.DATA}} 
{{notice.DATA}}
